<footer class="color-primary-4">
	...
	<ul>
            ...
            <li><?php echo $this->Html->link('<span class="fa fa-twitter fa-2x"></span>', 'https://twitter.com/findem_es', array('escape' => false, 'target' => '_blank','class'=>'footerlink'));?>
     <?php echo $this->Html->link('<span class="fa fa-facebook fa-2x"></span>', 'https://facebook.com/findem_es', array('escape' => false, 'target' => '_blank','class'=>'footerlink'));?>
     <?php echo $this->Html->link('<span class="fa fa-linkedin fa-2x"></span>', 'https://linkedin.com/findem_es', array('escape' => false, 'target' => '_blank','class'=>'footerlink'));?></li>
        </ul>
