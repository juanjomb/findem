...
<p class="message-body-from">De: <?php echo $message['From']['name']; ?></p>
    ...
    <?php echo $this->Html->link('<span class="fa fa-paper-plane fa-2x user-send-response" title="Enviar respuesta"></span>', array('controller' => 'users', 'action' => 'send_message',$message['From']['id']), array('escape' => false));?>
