...
<p class="message-body-from">De: <?php echo $message['From']['name']; ?></p>
    ...
    <?php echo $this->Html->link('<i class="fa fa-paper-plane fa-2x user-send-response"></i>', array('controller' => 'users', 'action' => 'send_message',$message['From']['id']), array('escape' => false));?>
